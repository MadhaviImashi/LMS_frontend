...
<div align="center">
  ...
  <br>
   ...
   <br>
    ...
    <br>
    <span>(From the given dropdown, librarian can lend the book to a member who has already registered to the system.)</span><br>
  <br><br>
    <span>Figure 1.3</span> <br>
   <img src="https://github.com/MadhaviImashi/LMS_frontend/blob/main/public/Demo_images/book4.PNG" alt="Madhavi's Header section" width="600" height="320">
    ...
    <span>( Once a book is lend to a library member, that book cannot be lend to any other member until that borrowed person return that particular book. Therefore, till the book is returned, librarian cannot either edit or delete that book as well.)</span>
    <br><br>
    <span>Also the name of the member who has borrowed the book can also be viewed from this interface(Figure 1.3) </span><br><br>
   <br>
 <div align="center">
    <span>Figure 1.4</span> <br>
  ...
  <br>
   ...
   <br><br>
    <h3> Interfaces related to Member management function </h3><hr>
    <span>Figure 2.0</span> <br>
